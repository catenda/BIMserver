...
public class SServiceGenerator
{
  ...
  protected final String TEXT_7 = "Service(SourceCodeFetcher sourceCodeFetcher, Class<? extends PublicInterface> cl) {" + NL + "\t\tsuper(sourceCodeFetcher, cl);" + NL + "\t}" + NL + "\t" + NL + "\t\tpublic void init() {" + NL + "\t\t\ttry {";
