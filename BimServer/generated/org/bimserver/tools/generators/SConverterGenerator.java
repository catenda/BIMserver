...
public class SConverterGenerator
{
  ...
  protected final String TEXT_3 = NL + NL + "import org.bimserver.emf.IdEObjectImpl;" + NL + "import org.bimserver.interfaces.objects.*;" + NL + "import java.util.*;" + NL + "import org.bimserver.models.log.*;" + NL + "import org.bimserver.models.store.*;" + NL + "import org.bimserver.database.DatabaseSession;" + NL + "import org.bimserver.database.BimserverDatabaseException;" + NL + "import org.bimserver.database.Query;" + NL + "" + NL + "public class SConverter {";
  ...
  protected final String TEXT_62 = NL + "\t\treturn result;" + NL + "\t}" + NL + "\tpublic ";
  protected final String TEXT_63 = " convertFromSObject(S";
  protected final String TEXT_64 = " input, DatabaseSession session) throws BimserverDatabaseException {" + NL + "\t\t";
  ...
  protected final String TEXT_69 = NL + "\t\treturn result;" + NL + "\t}" + NL + "" + NL + "\tpublic ";
  protected final String TEXT_70 = " input, ";
  protected final String TEXT_71 = " result, DatabaseSession session) throws BimserverDatabaseException {" + NL + "\t\tif (input == null) {" + NL + "\t\t\treturn null;" + NL + "\t\t}";
  protected final String TEXT_72 = "if (input instanceof S";
  protected final String TEXT_73 = ") {" + NL + "\t\t\treturn convertFromSObject((S";
  protected final String TEXT_74 = ")input, session);" + NL + "\t\t}";
  protected final String TEXT_75 = "(";
  protected final String TEXT_76 = NL + "\t\tList<";
  protected final String TEXT_77 = " = result.get";
  protected final String TEXT_78 = "();" + NL + "\t\tfor (S";
  protected final String TEXT_79 = ".add(convertFromSObject(v, session));" + NL + "\t\t}";
  protected final String TEXT_80 = "();" + NL + "\t\tfor (long oid : input.get";
  protected final String TEXT_81 = ".add((";
  protected final String TEXT_82 = ")session.get(";
  protected final String TEXT_83 = "Package.eINSTANCE.get";
  protected final String TEXT_84 = "(), oid, Query.getDefault()));" + NL + "\t\t}";
  protected final String TEXT_85 = "(convertFromSObject(input.get";
  protected final String TEXT_86 = "(), session));";
  protected final String TEXT_87 = "((";
  protected final String TEXT_88 = "(), input.get";
  protected final String TEXT_89 = "Id(), Query.getDefault()));";
  protected final String TEXT_90 = NL + "\t\treturn result;" + NL + "\t}";
  protected final String TEXT_91 = NL + "\t\tpublic S";
  protected final String TEXT_92 = " input) {" + NL + "\t\t\treturn S";
  protected final String TEXT_93 = ".values()[input.ordinal()];" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic ";
  protected final String TEXT_94 = " input) {" + NL + "\t\t\treturn ";
  protected final String TEXT_95 = ".values()[input.ordinal()];" + NL + "\t\t}";
