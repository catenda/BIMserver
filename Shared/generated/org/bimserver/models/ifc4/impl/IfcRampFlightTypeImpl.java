...
public class IfcRampFlightTypeImpl extends IfcBuildingElementTypeImpl implements IfcRampFlightType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcRampFlightType();
    }
    ...
    public IfcRampFlightTypeEnum getPredefinedType() {
        return (IfcRampFlightTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcRampFlightType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcRampFlightTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcRampFlightType_PredefinedType(), newPredefinedType);
    }
