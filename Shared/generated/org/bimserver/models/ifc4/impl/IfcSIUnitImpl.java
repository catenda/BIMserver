...
public class IfcSIUnitImpl extends IfcNamedUnitImpl implements IfcSIUnit {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcSIUnit();
    }
    ...
    public IfcSIPrefix getPrefix() {
        return (IfcSIPrefix) eGet(Ifc4Package.eINSTANCE.getIfcSIUnit_Prefix(), true);
    }
    ...
    public void setPrefix(IfcSIPrefix newPrefix) {
        eSet(Ifc4Package.eINSTANCE.getIfcSIUnit_Prefix(), newPrefix);
    }
    ...
    public void unsetPrefix() {
        eUnset(Ifc4Package.eINSTANCE.getIfcSIUnit_Prefix());
    }
    ...
    public boolean isSetPrefix() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcSIUnit_Prefix());
    }
    ...
    public IfcSIUnitName getName() {
        return (IfcSIUnitName) eGet(Ifc4Package.eINSTANCE.getIfcSIUnit_Name(), true);
    }
    ...
    public void setName(IfcSIUnitName newName) {
        eSet(Ifc4Package.eINSTANCE.getIfcSIUnit_Name(), newName);
    }
