...
public class IfcBuildingImpl extends IfcSpatialStructureElementImpl implements IfcBuilding {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcBuilding();
    }
    ...
    public double getElevationOfRefHeight() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfRefHeight(), true);
    }
    ...
    public void setElevationOfRefHeight(double newElevationOfRefHeight) {
        eSet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfRefHeight(), newElevationOfRefHeight);
    }
    ...
    public void unsetElevationOfRefHeight() {
        eUnset(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfRefHeight());
    }
    ...
    public boolean isSetElevationOfRefHeight() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfRefHeight());
    }
    ...
    public String getElevationOfRefHeightAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfRefHeightAsString(), true);
    }
    ...
    public void setElevationOfRefHeightAsString(String newElevationOfRefHeightAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfRefHeightAsString(), newElevationOfRefHeightAsString);
    }
    ...
    public void unsetElevationOfRefHeightAsString() {
        eUnset(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfRefHeightAsString());
    }
    ...
    public boolean isSetElevationOfRefHeightAsString() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfRefHeightAsString());
    }
    ...
    public double getElevationOfTerrain() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfTerrain(), true);
    }
    ...
    public void setElevationOfTerrain(double newElevationOfTerrain) {
        eSet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfTerrain(), newElevationOfTerrain);
    }
    ...
    public void unsetElevationOfTerrain() {
        eUnset(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfTerrain());
    }
    ...
    public boolean isSetElevationOfTerrain() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfTerrain());
    }
    ...
    public String getElevationOfTerrainAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfTerrainAsString(), true);
    }
    ...
    public void setElevationOfTerrainAsString(String newElevationOfTerrainAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfTerrainAsString(), newElevationOfTerrainAsString);
    }
    ...
    public void unsetElevationOfTerrainAsString() {
        eUnset(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfTerrainAsString());
    }
    ...
    public boolean isSetElevationOfTerrainAsString() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcBuilding_ElevationOfTerrainAsString());
    }
    ...
    public IfcPostalAddress getBuildingAddress() {
        return (IfcPostalAddress) eGet(Ifc4Package.eINSTANCE.getIfcBuilding_BuildingAddress(), true);
    }
    ...
    public void setBuildingAddress(IfcPostalAddress newBuildingAddress) {
        eSet(Ifc4Package.eINSTANCE.getIfcBuilding_BuildingAddress(), newBuildingAddress);
    }
    ...
    public void unsetBuildingAddress() {
        eUnset(Ifc4Package.eINSTANCE.getIfcBuilding_BuildingAddress());
    }
    ...
    public boolean isSetBuildingAddress() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcBuilding_BuildingAddress());
    }
