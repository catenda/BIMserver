...
public class IfcLineImpl extends IfcCurveImpl implements IfcLine {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcLine();
    }
    ...
    public IfcCartesianPoint getPnt() {
        return (IfcCartesianPoint) eGet(Ifc4Package.eINSTANCE.getIfcLine_Pnt(), true);
    }
    ...
    public void setPnt(IfcCartesianPoint newPnt) {
        eSet(Ifc4Package.eINSTANCE.getIfcLine_Pnt(), newPnt);
    }
    ...
    public IfcVector getDir() {
        return (IfcVector) eGet(Ifc4Package.eINSTANCE.getIfcLine_Dir(), true);
    }
    ...
    public void setDir(IfcVector newDir) {
        eSet(Ifc4Package.eINSTANCE.getIfcLine_Dir(), newDir);
    }
