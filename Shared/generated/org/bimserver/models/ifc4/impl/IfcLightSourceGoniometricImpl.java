...
public class IfcLightSourceGoniometricImpl extends IfcLightSourceImpl implements IfcLightSourceGoniometric {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric();
    }
    ...
    public IfcAxis2Placement3D getPosition() {
        return (IfcAxis2Placement3D) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_Position(), true);
    }
    ...
    public void setPosition(IfcAxis2Placement3D newPosition) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_Position(), newPosition);
    }
    ...
    public IfcColourRgb getColourAppearance() {
        return (IfcColourRgb) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_ColourAppearance(), true);
    }
    ...
    public void setColourAppearance(IfcColourRgb newColourAppearance) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_ColourAppearance(), newColourAppearance);
    }
    ...
    public void unsetColourAppearance() {
        eUnset(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_ColourAppearance());
    }
    ...
    public boolean isSetColourAppearance() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_ColourAppearance());
    }
    ...
    public double getColourTemperature() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_ColourTemperature(), true);
    }
    ...
    public void setColourTemperature(double newColourTemperature) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_ColourTemperature(), newColourTemperature);
    }
    ...
    public String getColourTemperatureAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_ColourTemperatureAsString(), true);
    }
    ...
    public void setColourTemperatureAsString(String newColourTemperatureAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_ColourTemperatureAsString(),
    ...
    public double getLuminousFlux() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_LuminousFlux(), true);
    }
    ...
    public void setLuminousFlux(double newLuminousFlux) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_LuminousFlux(), newLuminousFlux);
    }
    ...
    public String getLuminousFluxAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_LuminousFluxAsString(), true);
    }
    ...
    public void setLuminousFluxAsString(String newLuminousFluxAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_LuminousFluxAsString(), newLuminousFluxAsString);
    }
    ...
    public IfcLightEmissionSourceEnum getLightEmissionSource() {
        return (IfcLightEmissionSourceEnum) eGet(
                Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_LightEmissionSource(), true);
    }
    ...
    public void setLightEmissionSource(IfcLightEmissionSourceEnum newLightEmissionSource) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_LightEmissionSource(), newLightEmissionSource);
    }
    ...
    public IfcLightDistributionDataSourceSelect getLightDistributionDataSource() {
        return (IfcLightDistributionDataSourceSelect) eGet(
                Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_LightDistributionDataSource(), true);
    }
    ...
    public void setLightDistributionDataSource(IfcLightDistributionDataSourceSelect newLightDistributionDataSource) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceGoniometric_LightDistributionDataSource(),
