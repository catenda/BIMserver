...
public class IfcTransformerImpl extends IfcEnergyConversionDeviceImpl implements IfcTransformer {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcTransformer();
    }
    ...
    public IfcTransformerTypeEnum getPredefinedType() {
        return (IfcTransformerTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcTransformer_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcTransformerTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcTransformer_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcTransformer_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcTransformer_PredefinedType());
    }
