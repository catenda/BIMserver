...
public class IfcVibrationIsolatorImpl extends IfcElementComponentImpl implements IfcVibrationIsolator {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcVibrationIsolator();
    }
    ...
    public IfcVibrationIsolatorTypeEnum getPredefinedType() {
        return (IfcVibrationIsolatorTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcVibrationIsolator_PredefinedType(),
                true);
    }
    ...
    public void setPredefinedType(IfcVibrationIsolatorTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcVibrationIsolator_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcVibrationIsolator_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcVibrationIsolator_PredefinedType());
    }
