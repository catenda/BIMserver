...
public class IfcEdgeCurveImpl extends IfcEdgeImpl implements IfcEdgeCurve {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcEdgeCurve();
    }
    ...
    public IfcCurve getEdgeGeometry() {
        return (IfcCurve) eGet(Ifc4Package.eINSTANCE.getIfcEdgeCurve_EdgeGeometry(), true);
    }
    ...
    public void setEdgeGeometry(IfcCurve newEdgeGeometry) {
        eSet(Ifc4Package.eINSTANCE.getIfcEdgeCurve_EdgeGeometry(), newEdgeGeometry);
    }
    ...
    public Tristate getSameSense() {
        return (Tristate) eGet(Ifc4Package.eINSTANCE.getIfcEdgeCurve_SameSense(), true);
    }
    ...
    public void setSameSense(Tristate newSameSense) {
        eSet(Ifc4Package.eINSTANCE.getIfcEdgeCurve_SameSense(), newSameSense);
    }
