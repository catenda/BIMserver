...
public class IfcBuildingElementProxyImpl extends IfcBuildingElementImpl implements IfcBuildingElementProxy {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcBuildingElementProxy();
    }
    ...
    public IfcBuildingElementProxyTypeEnum getPredefinedType() {
        return (IfcBuildingElementProxyTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcBuildingElementProxy_PredefinedType(),
                true);
    }
    ...
    public void setPredefinedType(IfcBuildingElementProxyTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcBuildingElementProxy_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcBuildingElementProxy_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcBuildingElementProxy_PredefinedType());
    }
