...
public class IfcElectricMotorImpl extends IfcEnergyConversionDeviceImpl implements IfcElectricMotor {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcElectricMotor();
    }
    ...
    public IfcElectricMotorTypeEnum getPredefinedType() {
        return (IfcElectricMotorTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcElectricMotor_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcElectricMotorTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcElectricMotor_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcElectricMotor_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcElectricMotor_PredefinedType());
    }
