...
public class IfcDuctFittingTypeImpl extends IfcFlowFittingTypeImpl implements IfcDuctFittingType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcDuctFittingType();
    }
    ...
    public IfcDuctFittingTypeEnum getPredefinedType() {
        return (IfcDuctFittingTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcDuctFittingType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcDuctFittingTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcDuctFittingType_PredefinedType(), newPredefinedType);
    }
