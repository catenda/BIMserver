...
public class IfcIdentifierImpl extends IdEObjectImpl implements IfcIdentifier {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcIdentifier();
    }
    ...
    public String getWrappedValue() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcIdentifier_WrappedValue(), true);
    }
    ...
    public void setWrappedValue(String newWrappedValue) {
        eSet(Ifc4Package.eINSTANCE.getIfcIdentifier_WrappedValue(), newWrappedValue);
    }
    ...
    public void unsetWrappedValue() {
        eUnset(Ifc4Package.eINSTANCE.getIfcIdentifier_WrappedValue());
    }
    ...
    public boolean isSetWrappedValue() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcIdentifier_WrappedValue());
    }
