...
public class IfcFlowMeterTypeImpl extends IfcFlowControllerTypeImpl implements IfcFlowMeterType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcFlowMeterType();
    }
    ...
    public IfcFlowMeterTypeEnum getPredefinedType() {
        return (IfcFlowMeterTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcFlowMeterType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcFlowMeterTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcFlowMeterType_PredefinedType(), newPredefinedType);
    }
