...
public class IfcFireSuppressionTerminalImpl extends IfcFlowTerminalImpl implements IfcFireSuppressionTerminal {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcFireSuppressionTerminal();
    }
    ...
    public IfcFireSuppressionTerminalTypeEnum getPredefinedType() {
        return (IfcFireSuppressionTerminalTypeEnum) eGet(
                Ifc4Package.eINSTANCE.getIfcFireSuppressionTerminal_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcFireSuppressionTerminalTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcFireSuppressionTerminal_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcFireSuppressionTerminal_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcFireSuppressionTerminal_PredefinedType());
    }
