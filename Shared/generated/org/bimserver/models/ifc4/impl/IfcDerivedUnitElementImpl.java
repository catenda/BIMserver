...
public class IfcDerivedUnitElementImpl extends IdEObjectImpl implements IfcDerivedUnitElement {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcDerivedUnitElement();
    }
    ...
    public IfcNamedUnit getUnit() {
        return (IfcNamedUnit) eGet(Ifc4Package.eINSTANCE.getIfcDerivedUnitElement_Unit(), true);
    }
    ...
    public void setUnit(IfcNamedUnit newUnit) {
        eSet(Ifc4Package.eINSTANCE.getIfcDerivedUnitElement_Unit(), newUnit);
    }
    ...
    public long getExponent() {
        return (Long) eGet(Ifc4Package.eINSTANCE.getIfcDerivedUnitElement_Exponent(), true);
    }
    ...
    public void setExponent(long newExponent) {
        eSet(Ifc4Package.eINSTANCE.getIfcDerivedUnitElement_Exponent(), newExponent);
    }
