...
public class IfcBooleanResultImpl extends IfcGeometricRepresentationItemImpl implements IfcBooleanResult {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcBooleanResult();
    }
    ...
    public IfcBooleanOperator getOperator() {
        return (IfcBooleanOperator) eGet(Ifc4Package.eINSTANCE.getIfcBooleanResult_Operator(), true);
    }
    ...
    public void setOperator(IfcBooleanOperator newOperator) {
        eSet(Ifc4Package.eINSTANCE.getIfcBooleanResult_Operator(), newOperator);
    }
    ...
    public IfcBooleanOperand getFirstOperand() {
        return (IfcBooleanOperand) eGet(Ifc4Package.eINSTANCE.getIfcBooleanResult_FirstOperand(), true);
    }
    ...
    public void setFirstOperand(IfcBooleanOperand newFirstOperand) {
        eSet(Ifc4Package.eINSTANCE.getIfcBooleanResult_FirstOperand(), newFirstOperand);
    }
    ...
    public IfcBooleanOperand getSecondOperand() {
        return (IfcBooleanOperand) eGet(Ifc4Package.eINSTANCE.getIfcBooleanResult_SecondOperand(), true);
    }
    ...
    public void setSecondOperand(IfcBooleanOperand newSecondOperand) {
        eSet(Ifc4Package.eINSTANCE.getIfcBooleanResult_SecondOperand(), newSecondOperand);
    }
    ...
    @Override
    public long getDim() {
        return (Long) eGet(Ifc4Package.eINSTANCE.getIfcBooleanResult_Dim(), true);
    }
    ...
    public void setDim(long newDim) {
        eSet(Ifc4Package.eINSTANCE.getIfcBooleanResult_Dim(), newDim);
    }
    ...
    public void unsetDim() {
        eUnset(Ifc4Package.eINSTANCE.getIfcBooleanResult_Dim());
    }
    ...
    public boolean isSetDim() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcBooleanResult_Dim());
    }
