...
public class IfcLightDistributionDataImpl extends IdEObjectImpl implements IfcLightDistributionData {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcLightDistributionData();
    }
    ...
    public double getMainPlaneAngle() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcLightDistributionData_MainPlaneAngle(), true);
    }
    ...
    public void setMainPlaneAngle(double newMainPlaneAngle) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightDistributionData_MainPlaneAngle(), newMainPlaneAngle);
    }
    ...
    public String getMainPlaneAngleAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcLightDistributionData_MainPlaneAngleAsString(), true);
    }
    ...
    public void setMainPlaneAngleAsString(String newMainPlaneAngleAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightDistributionData_MainPlaneAngleAsString(), newMainPlaneAngleAsString);
    }
    ...
    public EList<Double> getSecondaryPlaneAngle() {
        return (EList<Double>) eGet(Ifc4Package.eINSTANCE.getIfcLightDistributionData_SecondaryPlaneAngle(), true);
    }
    ...
    public EList<String> getSecondaryPlaneAngleAsString() {
        return (EList<String>) eGet(Ifc4Package.eINSTANCE.getIfcLightDistributionData_SecondaryPlaneAngleAsString(),
                true);
    }
    ...
    public EList<Double> getLuminousIntensity() {
        return (EList<Double>) eGet(Ifc4Package.eINSTANCE.getIfcLightDistributionData_LuminousIntensity(), true);
    }
    ...
    public EList<String> getLuminousIntensityAsString() {
        return (EList<String>) eGet(Ifc4Package.eINSTANCE.getIfcLightDistributionData_LuminousIntensityAsString(),
                true);
    }
