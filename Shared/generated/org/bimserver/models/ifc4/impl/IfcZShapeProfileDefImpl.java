...
public class IfcZShapeProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcZShapeProfileDef {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcZShapeProfileDef();
    }
    ...
    public double getDepth() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_Depth(), true);
    }
    ...
    public void setDepth(double newDepth) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_Depth(), newDepth);
    }
    ...
    public String getDepthAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_DepthAsString(), true);
    }
    ...
    public void setDepthAsString(String newDepthAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_DepthAsString(), newDepthAsString);
    }
    ...
    public double getFlangeWidth() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FlangeWidth(), true);
    }
    ...
    public void setFlangeWidth(double newFlangeWidth) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FlangeWidth(), newFlangeWidth);
    }
    ...
    public String getFlangeWidthAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FlangeWidthAsString(), true);
    }
    ...
    public void setFlangeWidthAsString(String newFlangeWidthAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FlangeWidthAsString(), newFlangeWidthAsString);
    }
    ...
    public double getWebThickness() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_WebThickness(), true);
    }
    ...
    public void setWebThickness(double newWebThickness) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_WebThickness(), newWebThickness);
    }
    ...
    public String getWebThicknessAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_WebThicknessAsString(), true);
    }
    ...
    public void setWebThicknessAsString(String newWebThicknessAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_WebThicknessAsString(), newWebThicknessAsString);
    }
    ...
    public double getFlangeThickness() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FlangeThickness(), true);
    }
    ...
    public void setFlangeThickness(double newFlangeThickness) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FlangeThickness(), newFlangeThickness);
    }
    ...
    public String getFlangeThicknessAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FlangeThicknessAsString(), true);
    }
    ...
    public void setFlangeThicknessAsString(String newFlangeThicknessAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FlangeThicknessAsString(), newFlangeThicknessAsString);
    }
    ...
    public double getFilletRadius() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FilletRadius(), true);
    }
    ...
    public void setFilletRadius(double newFilletRadius) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FilletRadius(), newFilletRadius);
    }
    ...
    public void unsetFilletRadius() {
        eUnset(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FilletRadius());
    }
    ...
    public boolean isSetFilletRadius() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FilletRadius());
    }
    ...
    public String getFilletRadiusAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FilletRadiusAsString(), true);
    }
    ...
    public void setFilletRadiusAsString(String newFilletRadiusAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FilletRadiusAsString(), newFilletRadiusAsString);
    }
    ...
    public void unsetFilletRadiusAsString() {
        eUnset(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FilletRadiusAsString());
    }
    ...
    public boolean isSetFilletRadiusAsString() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_FilletRadiusAsString());
    }
    ...
    public double getEdgeRadius() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_EdgeRadius(), true);
    }
    ...
    public void setEdgeRadius(double newEdgeRadius) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_EdgeRadius(), newEdgeRadius);
    }
    ...
    public void unsetEdgeRadius() {
        eUnset(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_EdgeRadius());
    }
    ...
    public boolean isSetEdgeRadius() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_EdgeRadius());
    }
    ...
    public String getEdgeRadiusAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_EdgeRadiusAsString(), true);
    }
    ...
    public void setEdgeRadiusAsString(String newEdgeRadiusAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_EdgeRadiusAsString(), newEdgeRadiusAsString);
    }
    ...
    public void unsetEdgeRadiusAsString() {
        eUnset(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_EdgeRadiusAsString());
    }
    ...
    public boolean isSetEdgeRadiusAsString() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcZShapeProfileDef_EdgeRadiusAsString());
    }
