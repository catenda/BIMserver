...
public class IfcRailingTypeImpl extends IfcBuildingElementTypeImpl implements IfcRailingType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcRailingType();
    }
    ...
    public IfcRailingTypeEnum getPredefinedType() {
        return (IfcRailingTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcRailingType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcRailingTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcRailingType_PredefinedType(), newPredefinedType);
    }
