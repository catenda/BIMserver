...
public class IfcDoorPanelPropertiesImpl extends IfcPreDefinedPropertySetImpl implements IfcDoorPanelProperties {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcDoorPanelProperties();
    }
    ...
    public double getPanelDepth() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelDepth(), true);
    }
    ...
    public void setPanelDepth(double newPanelDepth) {
        eSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelDepth(), newPanelDepth);
    }
    ...
    public void unsetPanelDepth() {
        eUnset(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelDepth());
    }
    ...
    public boolean isSetPanelDepth() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelDepth());
    }
    ...
    public String getPanelDepthAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelDepthAsString(), true);
    }
    ...
    public void setPanelDepthAsString(String newPanelDepthAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelDepthAsString(), newPanelDepthAsString);
    }
    ...
    public void unsetPanelDepthAsString() {
        eUnset(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelDepthAsString());
    }
    ...
    public boolean isSetPanelDepthAsString() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelDepthAsString());
    }
    ...
    public IfcDoorPanelOperationEnum getPanelOperation() {
        return (IfcDoorPanelOperationEnum) eGet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelOperation(), true);
    }
    ...
    public void setPanelOperation(IfcDoorPanelOperationEnum newPanelOperation) {
        eSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelOperation(), newPanelOperation);
    }
    ...
    public double getPanelWidth() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelWidth(), true);
    }
    ...
    public void setPanelWidth(double newPanelWidth) {
        eSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelWidth(), newPanelWidth);
    }
    ...
    public void unsetPanelWidth() {
        eUnset(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelWidth());
    }
    ...
    public boolean isSetPanelWidth() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelWidth());
    }
    ...
    public String getPanelWidthAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelWidthAsString(), true);
    }
    ...
    public void setPanelWidthAsString(String newPanelWidthAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelWidthAsString(), newPanelWidthAsString);
    }
    ...
    public void unsetPanelWidthAsString() {
        eUnset(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelWidthAsString());
    }
    ...
    public boolean isSetPanelWidthAsString() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelWidthAsString());
    }
    ...
    public IfcDoorPanelPositionEnum getPanelPosition() {
        return (IfcDoorPanelPositionEnum) eGet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelPosition(), true);
    }
    ...
    public void setPanelPosition(IfcDoorPanelPositionEnum newPanelPosition) {
        eSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_PanelPosition(), newPanelPosition);
    }
    ...
    public IfcShapeAspect getShapeAspectStyle() {
        return (IfcShapeAspect) eGet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_ShapeAspectStyle(), true);
    }
    ...
    public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
        eSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_ShapeAspectStyle(), newShapeAspectStyle);
    }
    ...
    public void unsetShapeAspectStyle() {
        eUnset(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_ShapeAspectStyle());
    }
    ...
    public boolean isSetShapeAspectStyle() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcDoorPanelProperties_ShapeAspectStyle());
    }
