...
public class IfcPhysicalComplexQuantityImpl extends IfcPhysicalQuantityImpl implements IfcPhysicalComplexQuantity {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity();
    }
    ...
    public EList<IfcPhysicalQuantity> getHasQuantities() {
        return (EList<IfcPhysicalQuantity>) eGet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_HasQuantities(),
                true);
    }
    ...
    public String getDiscrimination() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Discrimination(), true);
    }
    ...
    public void setDiscrimination(String newDiscrimination) {
        eSet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Discrimination(), newDiscrimination);
    }
    ...
    public String getQuality() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Quality(), true);
    }
    ...
    public void setQuality(String newQuality) {
        eSet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Quality(), newQuality);
    }
    ...
    public void unsetQuality() {
        eUnset(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Quality());
    }
    ...
    public boolean isSetQuality() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Quality());
    }
    ...
    public String getUsage() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Usage(), true);
    }
    ...
    public void setUsage(String newUsage) {
        eSet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Usage(), newUsage);
    }
    ...
    public void unsetUsage() {
        eUnset(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Usage());
    }
    ...
    public boolean isSetUsage() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcPhysicalComplexQuantity_Usage());
    }
