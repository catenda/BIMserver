...
public class IfcRevolvedAreaSolidImpl extends IfcSweptAreaSolidImpl implements IfcRevolvedAreaSolid {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcRevolvedAreaSolid();
    }
    ...
    public IfcAxis1Placement getAxis() {
        return (IfcAxis1Placement) eGet(Ifc4Package.eINSTANCE.getIfcRevolvedAreaSolid_Axis(), true);
    }
    ...
    public void setAxis(IfcAxis1Placement newAxis) {
        eSet(Ifc4Package.eINSTANCE.getIfcRevolvedAreaSolid_Axis(), newAxis);
    }
    ...
    public double getAngle() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcRevolvedAreaSolid_Angle(), true);
    }
    ...
    public void setAngle(double newAngle) {
        eSet(Ifc4Package.eINSTANCE.getIfcRevolvedAreaSolid_Angle(), newAngle);
    }
    ...
    public String getAngleAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcRevolvedAreaSolid_AngleAsString(), true);
    }
    ...
    public void setAngleAsString(String newAngleAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcRevolvedAreaSolid_AngleAsString(), newAngleAsString);
    }
