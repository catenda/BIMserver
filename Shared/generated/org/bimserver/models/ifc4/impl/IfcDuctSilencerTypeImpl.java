...
public class IfcDuctSilencerTypeImpl extends IfcFlowTreatmentDeviceTypeImpl implements IfcDuctSilencerType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcDuctSilencerType();
    }
    ...
    public IfcDuctSilencerTypeEnum getPredefinedType() {
        return (IfcDuctSilencerTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcDuctSilencerType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcDuctSilencerTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcDuctSilencerType_PredefinedType(), newPredefinedType);
    }
