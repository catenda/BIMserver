...
public class IfcPlateImpl extends IfcBuildingElementImpl implements IfcPlate {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcPlate();
    }
    ...
    public IfcPlateTypeEnum getPredefinedType() {
        return (IfcPlateTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcPlate_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcPlateTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcPlate_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcPlate_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcPlate_PredefinedType());
    }
