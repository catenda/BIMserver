...
public class IfcPolygonalBoundedHalfSpaceImpl extends IfcHalfSpaceSolidImpl implements IfcPolygonalBoundedHalfSpace {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcPolygonalBoundedHalfSpace();
    }
    ...
    public IfcAxis2Placement3D getPosition() {
        return (IfcAxis2Placement3D) eGet(Ifc4Package.eINSTANCE.getIfcPolygonalBoundedHalfSpace_Position(), true);
    }
    ...
    public void setPosition(IfcAxis2Placement3D newPosition) {
        eSet(Ifc4Package.eINSTANCE.getIfcPolygonalBoundedHalfSpace_Position(), newPosition);
    }
    ...
    public IfcBoundedCurve getPolygonalBoundary() {
        return (IfcBoundedCurve) eGet(Ifc4Package.eINSTANCE.getIfcPolygonalBoundedHalfSpace_PolygonalBoundary(), true);
    }
    ...
    public void setPolygonalBoundary(IfcBoundedCurve newPolygonalBoundary) {
        eSet(Ifc4Package.eINSTANCE.getIfcPolygonalBoundedHalfSpace_PolygonalBoundary(), newPolygonalBoundary);
    }
