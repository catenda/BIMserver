...
public class IfcEvaporativeCoolerImpl extends IfcEnergyConversionDeviceImpl implements IfcEvaporativeCooler {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcEvaporativeCooler();
    }
    ...
    public IfcEvaporativeCoolerTypeEnum getPredefinedType() {
        return (IfcEvaporativeCoolerTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcEvaporativeCooler_PredefinedType(),
                true);
    }
    ...
    public void setPredefinedType(IfcEvaporativeCoolerTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcEvaporativeCooler_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcEvaporativeCooler_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcEvaporativeCooler_PredefinedType());
    }
