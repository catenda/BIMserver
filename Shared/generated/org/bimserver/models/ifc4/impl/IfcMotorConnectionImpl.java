...
public class IfcMotorConnectionImpl extends IfcEnergyConversionDeviceImpl implements IfcMotorConnection {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcMotorConnection();
    }
    ...
    public IfcMotorConnectionTypeEnum getPredefinedType() {
        return (IfcMotorConnectionTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcMotorConnection_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcMotorConnectionTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcMotorConnection_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcMotorConnection_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcMotorConnection_PredefinedType());
    }
