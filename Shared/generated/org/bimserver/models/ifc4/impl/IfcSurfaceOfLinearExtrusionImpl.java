...
public class IfcSurfaceOfLinearExtrusionImpl extends IfcSweptSurfaceImpl implements IfcSurfaceOfLinearExtrusion {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcSurfaceOfLinearExtrusion();
    }
    ...
    public IfcDirection getExtrudedDirection() {
        return (IfcDirection) eGet(Ifc4Package.eINSTANCE.getIfcSurfaceOfLinearExtrusion_ExtrudedDirection(), true);
    }
    ...
    public void setExtrudedDirection(IfcDirection newExtrudedDirection) {
        eSet(Ifc4Package.eINSTANCE.getIfcSurfaceOfLinearExtrusion_ExtrudedDirection(), newExtrudedDirection);
    }
    ...
    public double getDepth() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcSurfaceOfLinearExtrusion_Depth(), true);
    }
    ...
    public void setDepth(double newDepth) {
        eSet(Ifc4Package.eINSTANCE.getIfcSurfaceOfLinearExtrusion_Depth(), newDepth);
    }
    ...
    public String getDepthAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcSurfaceOfLinearExtrusion_DepthAsString(), true);
    }
    ...
    public void setDepthAsString(String newDepthAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcSurfaceOfLinearExtrusion_DepthAsString(), newDepthAsString);
    }
