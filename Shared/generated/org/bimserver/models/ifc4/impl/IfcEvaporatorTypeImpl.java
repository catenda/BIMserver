...
public class IfcEvaporatorTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcEvaporatorType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcEvaporatorType();
    }
    ...
    public IfcEvaporatorTypeEnum getPredefinedType() {
        return (IfcEvaporatorTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcEvaporatorType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcEvaporatorTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcEvaporatorType_PredefinedType(), newPredefinedType);
    }
