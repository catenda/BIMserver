...
public class IfcMeasureWithUnitImpl extends IdEObjectImpl implements IfcMeasureWithUnit {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcMeasureWithUnit();
    }
    ...
    public IfcValue getValueComponent() {
        return (IfcValue) eGet(Ifc4Package.eINSTANCE.getIfcMeasureWithUnit_ValueComponent(), true);
    }
    ...
    public void setValueComponent(IfcValue newValueComponent) {
        eSet(Ifc4Package.eINSTANCE.getIfcMeasureWithUnit_ValueComponent(), newValueComponent);
    }
    ...
    public IfcUnit getUnitComponent() {
        return (IfcUnit) eGet(Ifc4Package.eINSTANCE.getIfcMeasureWithUnit_UnitComponent(), true);
    }
    ...
    public void setUnitComponent(IfcUnit newUnitComponent) {
        eSet(Ifc4Package.eINSTANCE.getIfcMeasureWithUnit_UnitComponent(), newUnitComponent);
    }
