...
public class IfcFilterTypeImpl extends IfcFlowTreatmentDeviceTypeImpl implements IfcFilterType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcFilterType();
    }
    ...
    public IfcFilterTypeEnum getPredefinedType() {
        return (IfcFilterTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcFilterType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcFilterTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcFilterType_PredefinedType(), newPredefinedType);
    }
