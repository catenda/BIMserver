...
public class IfcBlockImpl extends IfcCsgPrimitive3DImpl implements IfcBlock {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcBlock();
    }
    ...
    public double getXLength() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcBlock_XLength(), true);
    }
    ...
    public void setXLength(double newXLength) {
        eSet(Ifc4Package.eINSTANCE.getIfcBlock_XLength(), newXLength);
    }
    ...
    public String getXLengthAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcBlock_XLengthAsString(), true);
    }
    ...
    public void setXLengthAsString(String newXLengthAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcBlock_XLengthAsString(), newXLengthAsString);
    }
    ...
    public double getYLength() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcBlock_YLength(), true);
    }
    ...
    public void setYLength(double newYLength) {
        eSet(Ifc4Package.eINSTANCE.getIfcBlock_YLength(), newYLength);
    }
    ...
    public String getYLengthAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcBlock_YLengthAsString(), true);
    }
    ...
    public void setYLengthAsString(String newYLengthAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcBlock_YLengthAsString(), newYLengthAsString);
    }
    ...
    public double getZLength() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcBlock_ZLength(), true);
    }
    ...
    public void setZLength(double newZLength) {
        eSet(Ifc4Package.eINSTANCE.getIfcBlock_ZLength(), newZLength);
    }
    ...
    public String getZLengthAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcBlock_ZLengthAsString(), true);
    }
    ...
    public void setZLengthAsString(String newZLengthAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcBlock_ZLengthAsString(), newZLengthAsString);
    }
