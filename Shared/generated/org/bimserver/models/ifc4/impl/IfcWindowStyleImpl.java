...
public class IfcWindowStyleImpl extends IfcTypeProductImpl implements IfcWindowStyle {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcWindowStyle();
    }
    ...
    public IfcWindowStyleConstructionEnum getConstructionType() {
        return (IfcWindowStyleConstructionEnum) eGet(Ifc4Package.eINSTANCE.getIfcWindowStyle_ConstructionType(), true);
    }
    ...
    public void setConstructionType(IfcWindowStyleConstructionEnum newConstructionType) {
        eSet(Ifc4Package.eINSTANCE.getIfcWindowStyle_ConstructionType(), newConstructionType);
    }
    ...
    public IfcWindowStyleOperationEnum getOperationType() {
        return (IfcWindowStyleOperationEnum) eGet(Ifc4Package.eINSTANCE.getIfcWindowStyle_OperationType(), true);
    }
    ...
    public void setOperationType(IfcWindowStyleOperationEnum newOperationType) {
        eSet(Ifc4Package.eINSTANCE.getIfcWindowStyle_OperationType(), newOperationType);
    }
    ...
    public Tristate getParameterTakesPrecedence() {
        return (Tristate) eGet(Ifc4Package.eINSTANCE.getIfcWindowStyle_ParameterTakesPrecedence(), true);
    }
    ...
    public void setParameterTakesPrecedence(Tristate newParameterTakesPrecedence) {
        eSet(Ifc4Package.eINSTANCE.getIfcWindowStyle_ParameterTakesPrecedence(), newParameterTakesPrecedence);
    }
    ...
    public Tristate getSizeable() {
        return (Tristate) eGet(Ifc4Package.eINSTANCE.getIfcWindowStyle_Sizeable(), true);
    }
    ...
    public void setSizeable(Tristate newSizeable) {
        eSet(Ifc4Package.eINSTANCE.getIfcWindowStyle_Sizeable(), newSizeable);
    }
