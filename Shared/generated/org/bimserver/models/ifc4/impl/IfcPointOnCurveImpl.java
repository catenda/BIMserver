...
public class IfcPointOnCurveImpl extends IfcPointImpl implements IfcPointOnCurve {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcPointOnCurve();
    }
    ...
    public IfcCurve getBasisCurve() {
        return (IfcCurve) eGet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_BasisCurve(), true);
    }
    ...
    public void setBasisCurve(IfcCurve newBasisCurve) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_BasisCurve(), newBasisCurve);
    }
    ...
    public double getPointParameter() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_PointParameter(), true);
    }
    ...
    public void setPointParameter(double newPointParameter) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_PointParameter(), newPointParameter);
    }
    ...
    public String getPointParameterAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_PointParameterAsString(), true);
    }
    ...
    public void setPointParameterAsString(String newPointParameterAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_PointParameterAsString(), newPointParameterAsString);
    }
    ...
    @Override
    public long getDim() {
        return (Long) eGet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_Dim(), true);
    }
    ...
    public void setDim(long newDim) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_Dim(), newDim);
    }
    ...
    public void unsetDim() {
        eUnset(Ifc4Package.eINSTANCE.getIfcPointOnCurve_Dim());
    }
    ...
    public boolean isSetDim() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcPointOnCurve_Dim());
    }
