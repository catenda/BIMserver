...
public class IfcAlarmTypeImpl extends IfcDistributionControlElementTypeImpl implements IfcAlarmType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcAlarmType();
    }
    ...
    public IfcAlarmTypeEnum getPredefinedType() {
        return (IfcAlarmTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcAlarmType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcAlarmTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcAlarmType_PredefinedType(), newPredefinedType);
    }
