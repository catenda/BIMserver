...
public class IfcCenterLineProfileDefImpl extends IfcArbitraryOpenProfileDefImpl implements IfcCenterLineProfileDef {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcCenterLineProfileDef();
    }
    ...
    public double getThickness() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcCenterLineProfileDef_Thickness(), true);
    }
    ...
    public void setThickness(double newThickness) {
        eSet(Ifc4Package.eINSTANCE.getIfcCenterLineProfileDef_Thickness(), newThickness);
    }
    ...
    public String getThicknessAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcCenterLineProfileDef_ThicknessAsString(), true);
    }
    ...
    public void setThicknessAsString(String newThicknessAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcCenterLineProfileDef_ThicknessAsString(), newThicknessAsString);
    }
