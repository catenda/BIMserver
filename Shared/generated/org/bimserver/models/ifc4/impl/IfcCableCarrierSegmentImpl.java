...
public class IfcCableCarrierSegmentImpl extends IfcFlowSegmentImpl implements IfcCableCarrierSegment {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcCableCarrierSegment();
    }
    ...
    public IfcCableCarrierSegmentTypeEnum getPredefinedType() {
        return (IfcCableCarrierSegmentTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcCableCarrierSegment_PredefinedType(),
                true);
    }
    ...
    public void setPredefinedType(IfcCableCarrierSegmentTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcCableCarrierSegment_PredefinedType(), newPredefinedType);
    }
    ...
    public void unsetPredefinedType() {
        eUnset(Ifc4Package.eINSTANCE.getIfcCableCarrierSegment_PredefinedType());
    }
    ...
    public boolean isSetPredefinedType() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcCableCarrierSegment_PredefinedType());
    }
