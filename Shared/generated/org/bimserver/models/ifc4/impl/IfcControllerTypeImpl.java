...
public class IfcControllerTypeImpl extends IfcDistributionControlElementTypeImpl implements IfcControllerType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcControllerType();
    }
    ...
    public IfcControllerTypeEnum getPredefinedType() {
        return (IfcControllerTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcControllerType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcControllerTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcControllerType_PredefinedType(), newPredefinedType);
    }
