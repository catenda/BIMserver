...
public class IfcPointOnSurfaceImpl extends IfcPointImpl implements IfcPointOnSurface {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcPointOnSurface();
    }
    ...
    public IfcSurface getBasisSurface() {
        return (IfcSurface) eGet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_BasisSurface(), true);
    }
    ...
    public void setBasisSurface(IfcSurface newBasisSurface) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_BasisSurface(), newBasisSurface);
    }
    ...
    public double getPointParameterU() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_PointParameterU(), true);
    }
    ...
    public void setPointParameterU(double newPointParameterU) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_PointParameterU(), newPointParameterU);
    }
    ...
    public String getPointParameterUAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_PointParameterUAsString(), true);
    }
    ...
    public void setPointParameterUAsString(String newPointParameterUAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_PointParameterUAsString(), newPointParameterUAsString);
    }
    ...
    public double getPointParameterV() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_PointParameterV(), true);
    }
    ...
    public void setPointParameterV(double newPointParameterV) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_PointParameterV(), newPointParameterV);
    }
    ...
    public String getPointParameterVAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_PointParameterVAsString(), true);
    }
    ...
    public void setPointParameterVAsString(String newPointParameterVAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_PointParameterVAsString(), newPointParameterVAsString);
    }
    ...
    @Override
    public long getDim() {
        return (Long) eGet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_Dim(), true);
    }
    ...
    public void setDim(long newDim) {
        eSet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_Dim(), newDim);
    }
    ...
    public void unsetDim() {
        eUnset(Ifc4Package.eINSTANCE.getIfcPointOnSurface_Dim());
    }
    ...
    public boolean isSetDim() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcPointOnSurface_Dim());
    }
