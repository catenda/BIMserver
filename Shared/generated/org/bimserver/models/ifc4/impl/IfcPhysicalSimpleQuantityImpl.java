...
public class IfcPhysicalSimpleQuantityImpl extends IfcPhysicalQuantityImpl implements IfcPhysicalSimpleQuantity {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcPhysicalSimpleQuantity();
    }
    ...
    public IfcNamedUnit getUnit() {
        return (IfcNamedUnit) eGet(Ifc4Package.eINSTANCE.getIfcPhysicalSimpleQuantity_Unit(), true);
    }
    ...
    public void setUnit(IfcNamedUnit newUnit) {
        eSet(Ifc4Package.eINSTANCE.getIfcPhysicalSimpleQuantity_Unit(), newUnit);
    }
    ...
    public void unsetUnit() {
        eUnset(Ifc4Package.eINSTANCE.getIfcPhysicalSimpleQuantity_Unit());
    }
    ...
    public boolean isSetUnit() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcPhysicalSimpleQuantity_Unit());
    }
