...
public class IfcTransportElementTypeImpl extends IfcElementTypeImpl implements IfcTransportElementType {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcTransportElementType();
    }
    ...
    public IfcTransportElementTypeEnum getPredefinedType() {
        return (IfcTransportElementTypeEnum) eGet(Ifc4Package.eINSTANCE.getIfcTransportElementType_PredefinedType(),
                true);
    }
    ...
    public void setPredefinedType(IfcTransportElementTypeEnum newPredefinedType) {
        eSet(Ifc4Package.eINSTANCE.getIfcTransportElementType_PredefinedType(), newPredefinedType);
    }
