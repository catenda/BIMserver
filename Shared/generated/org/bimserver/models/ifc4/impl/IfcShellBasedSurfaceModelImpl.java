...
public class IfcShellBasedSurfaceModelImpl extends IfcGeometricRepresentationItemImpl
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcShellBasedSurfaceModel();
    }
    ...
    public EList<IfcShell> getSbsmBoundary() {
        return (EList<IfcShell>) eGet(Ifc4Package.eINSTANCE.getIfcShellBasedSurfaceModel_SbsmBoundary(), true);
    }
    ...
    @Override
    public long getDim() {
        return (Long) eGet(Ifc4Package.eINSTANCE.getIfcShellBasedSurfaceModel_Dim(), true);
    }
    ...
    public void setDim(long newDim) {
        eSet(Ifc4Package.eINSTANCE.getIfcShellBasedSurfaceModel_Dim(), newDim);
    }
    ...
    public void unsetDim() {
        eUnset(Ifc4Package.eINSTANCE.getIfcShellBasedSurfaceModel_Dim());
    }
    ...
    public boolean isSetDim() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcShellBasedSurfaceModel_Dim());
    }
