...
public class IfcLightSourceSpotImpl extends IfcLightSourcePositionalImpl implements IfcLightSourceSpot {
    ...
    protected EClass eStaticClass() {
        return Ifc4Package.eINSTANCE.getIfcLightSourceSpot();
    }
    ...
    public IfcDirection getOrientation() {
        return (IfcDirection) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_Orientation(), true);
    }
    ...
    public void setOrientation(IfcDirection newOrientation) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_Orientation(), newOrientation);
    }
    ...
    public double getConcentrationExponent() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_ConcentrationExponent(), true);
    }
    ...
    public void setConcentrationExponent(double newConcentrationExponent) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_ConcentrationExponent(), newConcentrationExponent);
    }
    ...
    public void unsetConcentrationExponent() {
        eUnset(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_ConcentrationExponent());
    }
    ...
    public boolean isSetConcentrationExponent() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_ConcentrationExponent());
    }
    ...
    public String getConcentrationExponentAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_ConcentrationExponentAsString(), true);
    }
    ...
    public void setConcentrationExponentAsString(String newConcentrationExponentAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_ConcentrationExponentAsString(),
    ...
    public void unsetConcentrationExponentAsString() {
        eUnset(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_ConcentrationExponentAsString());
    }
    ...
    public boolean isSetConcentrationExponentAsString() {
        return eIsSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_ConcentrationExponentAsString());
    }
    ...
    public double getSpreadAngle() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_SpreadAngle(), true);
    }
    ...
    public void setSpreadAngle(double newSpreadAngle) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_SpreadAngle(), newSpreadAngle);
    }
    ...
    public String getSpreadAngleAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_SpreadAngleAsString(), true);
    }
    ...
    public void setSpreadAngleAsString(String newSpreadAngleAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_SpreadAngleAsString(), newSpreadAngleAsString);
    }
    ...
    public double getBeamWidthAngle() {
        return (Double) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_BeamWidthAngle(), true);
    }
    ...
    public void setBeamWidthAngle(double newBeamWidthAngle) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_BeamWidthAngle(), newBeamWidthAngle);
    }
    ...
    public String getBeamWidthAngleAsString() {
        return (String) eGet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_BeamWidthAngleAsString(), true);
    }
    ...
    public void setBeamWidthAngleAsString(String newBeamWidthAngleAsString) {
        eSet(Ifc4Package.eINSTANCE.getIfcLightSourceSpot_BeamWidthAngleAsString(), newBeamWidthAngleAsString);
    }
