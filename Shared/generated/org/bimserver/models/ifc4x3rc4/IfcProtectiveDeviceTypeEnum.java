 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3rc4.Ifc4x3rc4Package#getIfcProtectiveDeviceTypeEnum()
 * @model
 * @generated
 */
public enum IfcProtectiveDeviceTypeEnum implements Enumerator {
     ...
     * @ordered
     */
    ANTI_ARCING_DEVICE(3, "ANTI_ARCING_DEVICE", "ANTI_ARCING_DEVICE"),
     ...
     * @ordered
     */
    public static final int ANTI_ARCING_DEVICE_VALUE = 3;
    ...
    private static final IfcProtectiveDeviceTypeEnum[] VALUES_ARRAY = new IfcProtectiveDeviceTypeEnum[] { NULL,
            EARTHINGSWITCH, RESIDUALCURRENTCIRCUITBREAKER, ANTI_ARCING_DEVICE, NOTDEFINED, EARTHLEAKAGECIRCUITBREAKER,
