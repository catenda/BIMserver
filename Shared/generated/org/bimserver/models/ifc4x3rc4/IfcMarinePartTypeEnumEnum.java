...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Marine Part Type Enum Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3rc4.Ifc4x3rc4Package#getIfcMarinePartTypeEnumEnum()
 * @model
 * @generated
 */
public enum IfcMarinePartTypeEnumEnum implements Enumerator {
    /**
     ...
     * @ordered
     */
    CILL_LEVEL(7, "CILL_LEVEL", "CILL_LEVEL"),
     ...
     * @ordered
     */
    APPROACHCHANNEL(8, "APPROACHCHANNEL", "APPROACHCHANNEL"),
     ...
     * @ordered
     */
    LOWWATERLINE(11, "LOWWATERLINE", "LOWWATERLINE"),
     ...
     * @ordered
     */
    VEHICLESERVICING(12, "VEHICLESERVICING", "VEHICLESERVICING"),
     ...
     * @ordered
     */
    ANCHORAGE(13, "ANCHORAGE", "ANCHORAGE"),
     ...
     * @ordered
     */
    LANDFIELD(20, "LANDFIELD", "LANDFIELD"),
     ...
     * @ordered
     */
    ABOVEWATERLINE(21, "ABOVEWATERLINE", "ABOVEWATERLINE"),
     ...
     * @ordered
     */
    public static final int CILL_LEVEL_VALUE = 7;
     ...
     * @ordered
     */
    public static final int APPROACHCHANNEL_VALUE = 8;
     ...
     * @ordered
     */
    public static final int LOWWATERLINE_VALUE = 11;
     ...
     * @ordered
     */
    public static final int VEHICLESERVICING_VALUE = 12;
     ...
     * @ordered
     */
    public static final int ANCHORAGE_VALUE = 13;
     ...
     * @ordered
     */
    public static final int LANDFIELD_VALUE = 20;
     ...
     * @ordered
     */
    public static final int ABOVEWATERLINE_VALUE = 21;
    ...
    /**
     * An array of all the '<em><b>Ifc Marine Part Type Enum Enum</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final IfcMarinePartTypeEnumEnum[] VALUES_ARRAY = new IfcMarinePartTypeEnumEnum[] { NULL, CORE, CREST,
            COPELEVEL, GATEHEAD, USERDEFINED, LEEWARDSIDE, CILL_LEVEL, APPROACHCHANNEL, GUDINGSTRUCTURE, NOTDEFINED,
            LOWWATERLINE, VEHICLESERVICING, ANCHORAGE, NAVIGATIONALAREA, BELOWWATERLINE, BERTHINGSTRUCTURE,
            SHIPTRANSFER, WEATHERSIDE, PROTECTION, LANDFIELD, ABOVEWATERLINE, CHAMBER, STORAGEAREA, WATERFIELD,
            MANUFACTURING, HIGHWATERLINE, };

    /**
     * A public read-only list of all the '<em><b>Ifc Marine Part Type Enum Enum</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<IfcMarinePartTypeEnumEnum> VALUES = Collections
            .unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>Ifc Marine Part Type Enum Enum</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static IfcMarinePartTypeEnumEnum get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IfcMarinePartTypeEnumEnum result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Ifc Marine Part Type Enum Enum</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static IfcMarinePartTypeEnumEnum getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IfcMarinePartTypeEnumEnum result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Ifc Marine Part Type Enum Enum</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static IfcMarinePartTypeEnumEnum get(int value) {
        switch (value) {
        case NULL_VALUE:
            return NULL;
        case CORE_VALUE:
     ...
     * @generated
     */
    private IfcMarinePartTypeEnumEnum(int value, String name, String literal) {
        this.value = value;
        this.name = name;
