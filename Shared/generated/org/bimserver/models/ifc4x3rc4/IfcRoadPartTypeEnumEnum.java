...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Road Part Type Enum Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3rc4.Ifc4x3rc4Package#getIfcRoadPartTypeEnumEnum()
 * @model
 * @generated
 */
public enum IfcRoadPartTypeEnumEnum implements Enumerator {
    /**
     ...
     * @ordered
     */
    CENTRALISLAND(4, "CENTRALISLAND", "CENTRALISLAND"),
     ...
     * @ordered
     */
    ROADWAYPLATEAU(7, "ROADWAYPLATEAU", "ROADWAYPLATEAU"),
     ...
     * @ordered
     */
    public static final int SIDEWALK_VALUE = 3;
     ...
     * @ordered
     */
    public static final int CENTRALISLAND_VALUE = 4;
     ...
     * @ordered
     */
    public static final int ROADWAYPLATEAU_VALUE = 7;
     ...
     * @ordered
     */
    public static final int ROADSIDE_VALUE = 8;
    ...
    /**
     * An array of all the '<em><b>Ifc Road Part Type Enum Enum</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final IfcRoadPartTypeEnumEnum[] VALUES_ARRAY = new IfcRoadPartTypeEnumEnum[] { NULL, BUS_STOP,
            SHOULDER, SIDEWALK, CENTRALISLAND, PARKINGBAY, USERDEFINED, ROADWAYPLATEAU, ROADSIDE, RAILWAYCROSSING,
            CENTRALRESERVE, NOTDEFINED, REFUGEISLAND, TRAFFICLANE, HARDSHOULDER, LAYBY, TOLLPLAZA, ROADSIDEPART,
            CARRIAGEWAY, SOFTSHOULDER, BICYCLECROSSING, PEDESTRIAN_CROSSING, PASSINGBAY, TRAFFICISLAND, INTERSECTION,
            ROUNDABOUT, ROADSEGMENT, };

    /**
     * A public read-only list of all the '<em><b>Ifc Road Part Type Enum Enum</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<IfcRoadPartTypeEnumEnum> VALUES = Collections
            .unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>Ifc Road Part Type Enum Enum</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static IfcRoadPartTypeEnumEnum get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IfcRoadPartTypeEnumEnum result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Ifc Road Part Type Enum Enum</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static IfcRoadPartTypeEnumEnum getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IfcRoadPartTypeEnumEnum result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Ifc Road Part Type Enum Enum</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static IfcRoadPartTypeEnumEnum get(int value) {
        switch (value) {
        case NULL_VALUE:
            return NULL;
        case BUS_STOP_VALUE:
     ...
     * @generated
     */
    private IfcRoadPartTypeEnumEnum(int value, String name, String literal) {
        this.value = value;
        this.name = name;
