...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Facility Part Common Type Enum Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3rc4.Ifc4x3rc4Package#getIfcFacilityPartCommonTypeEnumEnum()
 * @model
 * @generated
 */
public enum IfcFacilityPartCommonTypeEnumEnum implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>Ifc Facility Part Common Type Enum Enum</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final IfcFacilityPartCommonTypeEnumEnum[] VALUES_ARRAY = new IfcFacilityPartCommonTypeEnumEnum[] {
            NULL, TERMINAL, NOTDEFINED, SEGMENT, SUPERSTRUCTURE, ABOVEGROUND, BELOWGROUND, USERDEFINED, LEVELCROSSING,
            JUNCTION, SUBSTRUCTURE, };

    /**
     * A public read-only list of all the '<em><b>Ifc Facility Part Common Type Enum Enum</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<IfcFacilityPartCommonTypeEnumEnum> VALUES = Collections
            .unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>Ifc Facility Part Common Type Enum Enum</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static IfcFacilityPartCommonTypeEnumEnum get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IfcFacilityPartCommonTypeEnumEnum result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Ifc Facility Part Common Type Enum Enum</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static IfcFacilityPartCommonTypeEnumEnum getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IfcFacilityPartCommonTypeEnumEnum result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Ifc Facility Part Common Type Enum Enum</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static IfcFacilityPartCommonTypeEnumEnum get(int value) {
        switch (value) {
        case NULL_VALUE:
            return NULL;
        case TERMINAL_VALUE:
     ...
     * @generated
     */
    private IfcFacilityPartCommonTypeEnumEnum(int value, String name, String literal) {
        this.value = value;
        this.name = name;
...
} //IfcFacilityPartCommonTypeEnumEnum
