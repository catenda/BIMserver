 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3rc4.Ifc4x3rc4Package#getIfcSurfaceFeatureTypeEnum()
 * @model
 * @generated
 */
public enum IfcSurfaceFeatureTypeEnum implements Enumerator {
     ...
     * @ordered
     */
    TRANSVERSERUMBLESTRIP(5, "TRANSVERSERUMBLESTRIP", "TRANSVERSERUMBLESTRIP"),
     ...
     * @ordered
     */
    public static final int TRANSVERSERUMBLESTRIP_VALUE = 5;
    ...
    private static final IfcSurfaceFeatureTypeEnum[] VALUES_ARRAY = new IfcSurfaceFeatureTypeEnum[] { NULL,
            SYMBOLMARKING, HATCHMARKING, DEFECT, TREATMENT, TRANSVERSERUMBLESTRIP, USERDEFINED, MARK, RUMBLESTRIP,
