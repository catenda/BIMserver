 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3rc4.Ifc4x3rc4Package#getIfcBeamTypeEnum()
 * @model
 * @generated
 */
public enum IfcBeamTypeEnum implements Enumerator {
     ...
     * @ordered
     */
    public static final int LINTEL_VALUE = 9;
     ...
     * @ordered
     */
    public static final int HATSTONE_VALUE = 10;
    ...
    private static final IfcBeamTypeEnum[] VALUES_ARRAY = new IfcBeamTypeEnum[] { NULL, EDGEBEAM, GIRDER_SEGMENT, TBEAM,
            USERDEFINED, BEAM, DIAPHRAGM, JOIST, NOTDEFINED, LINTEL, HATSTONE, SPANDREL, PIERCAP, CORNICE,
            HOLLOWCORE, };
