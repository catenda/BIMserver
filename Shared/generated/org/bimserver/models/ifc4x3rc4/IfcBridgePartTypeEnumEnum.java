...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Bridge Part Type Enum Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3rc4.Ifc4x3rc4Package#getIfcBridgePartTypeEnumEnum()
 * @model
 * @generated
 */
public enum IfcBridgePartTypeEnumEnum implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>Ifc Bridge Part Type Enum Enum</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final IfcBridgePartTypeEnumEnum[] VALUES_ARRAY = new IfcBridgePartTypeEnumEnum[] { NULL, FOUNDATION,
            PYLON, NOTDEFINED, PIER, DECK_SEGMENT, SUPERSTRUCTURE, DECK, ABUTMENT, USERDEFINED, PIER_SEGMENT,
            SURFACESTRUCTURE, SUBSTRUCTURE, };

    /**
     * A public read-only list of all the '<em><b>Ifc Bridge Part Type Enum Enum</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<IfcBridgePartTypeEnumEnum> VALUES = Collections
            .unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>Ifc Bridge Part Type Enum Enum</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static IfcBridgePartTypeEnumEnum get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IfcBridgePartTypeEnumEnum result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Ifc Bridge Part Type Enum Enum</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static IfcBridgePartTypeEnumEnum getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IfcBridgePartTypeEnumEnum result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Ifc Bridge Part Type Enum Enum</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static IfcBridgePartTypeEnumEnum get(int value) {
        switch (value) {
        case NULL_VALUE:
            return NULL;
     ...
     * @generated
     */
    private IfcBridgePartTypeEnumEnum(int value, String name, String literal) {
        this.value = value;
        this.name = name;
