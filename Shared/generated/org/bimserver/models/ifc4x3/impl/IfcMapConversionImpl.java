 ...
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcMapConversionImpl#getScaleY <em>Scale Y</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcMapConversionImpl#getScaleYAsString <em>Scale YAs String</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcMapConversionImpl#getScaleZ <em>Scale Z</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcMapConversionImpl#getScaleZAsString <em>Scale ZAs String</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfcMapConversionImpl extends IfcCoordinateOperationImpl implements IfcMapConversion {
    ...
    public double getScaleY() {
        return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleY(), true);
    }
    ...
    public void setScaleY(double newScaleY) {
        eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleY(), newScaleY);
    }
    ...
    public void unsetScaleY() {
        eUnset(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleY());
    }
    ...
    public boolean isSetScaleY() {
        return eIsSet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleY());
    }
    ...
    public String getScaleYAsString() {
        return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleYAsString(), true);
    }
    ...
    public void setScaleYAsString(String newScaleYAsString) {
        eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleYAsString(), newScaleYAsString);
    }
    ...
    public void unsetScaleYAsString() {
        eUnset(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleYAsString());
    }
    ...
    public boolean isSetScaleYAsString() {
        return eIsSet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleYAsString());
    }
    ...
    public double getScaleZ() {
        return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleZ(), true);
    }
    ...
    public void setScaleZ(double newScaleZ) {
        eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleZ(), newScaleZ);
    }
    ...
    public void unsetScaleZ() {
        eUnset(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleZ());
    }
    ...
    public boolean isSetScaleZ() {
        return eIsSet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleZ());
    }
    ...
    public String getScaleZAsString() {
        return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleZAsString(), true);
    }
    ...
    public void setScaleZAsString(String newScaleZAsString) {
        eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleZAsString(), newScaleZAsString);
    }
    ...
    public void unsetScaleZAsString() {
        eUnset(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleZAsString());
    }
    ...
    public boolean isSetScaleZAsString() {
        return eIsSet(Ifc4x3Package.eINSTANCE.getIfcMapConversion_ScaleZAsString());
    }
