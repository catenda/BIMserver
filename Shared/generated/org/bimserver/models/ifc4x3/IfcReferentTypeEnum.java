...
public enum IfcReferentTypeEnum implements Enumerator {
     ...
     * @ordered
     */
    REFERENCEMARKER(3, "REFERENCEMARKER", "REFERENCEMARKER"),
     ...
     * @ordered
     */
    INTERSECTION(6, "INTERSECTION", "INTERSECTION"),
     ...
     * @ordered
     */
    MILEPOINT(7, "MILEPOINT", "MILEPOINT"),
     ...
     * @ordered
     */
    KILOPOINT(8, "KILOPOINT", "KILOPOINT"),
     ...
     * @ordered
     */
    public static final int REFERENCEMARKER_VALUE = 3;
     ...
     * @ordered
     */
    public static final int STATION_VALUE = 5;
     ...
     * @ordered
     */
    public static final int MILEPOINT_VALUE = 7;
     ...
     * @ordered
     */
    public static final int KILOPOINT_VALUE = 8;
     ...
     * @ordered
     */
    public static final int BOUNDARY_VALUE = 9;
     ...
     * @generated
     */
    private static final IfcReferentTypeEnum[] VALUES_ARRAY = new IfcReferentTypeEnum[] { NULL, POSITION, LANDMARK,
            REFERENCEMARKER, NOTDEFINED, STATION, INTERSECTION, MILEPOINT, KILOPOINT, BOUNDARY, USERDEFINED, };
