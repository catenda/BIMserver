...
public class IfcCircleProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcCircleProfileDef {
    ...
    protected EClass eStaticClass() {
        return Ifc2x3tc1Package.eINSTANCE.getIfcCircleProfileDef();
    }
    ...
    public double getRadius() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCircleProfileDef_Radius(), true);
    }
    ...
    public void setRadius(double newRadius) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCircleProfileDef_Radius(), newRadius);
    }
    ...
    public String getRadiusAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCircleProfileDef_RadiusAsString(), true);
    }
    ...
    public void setRadiusAsString(String newRadiusAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCircleProfileDef_RadiusAsString(), newRadiusAsString);
    }
