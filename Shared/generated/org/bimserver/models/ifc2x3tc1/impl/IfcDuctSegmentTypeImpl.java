...
public class IfcDuctSegmentTypeImpl extends IfcFlowSegmentTypeImpl implements IfcDuctSegmentType {
    ...
    protected EClass eStaticClass() {
        return Ifc2x3tc1Package.eINSTANCE.getIfcDuctSegmentType();
    }
    ...
    public IfcDuctSegmentTypeEnum getPredefinedType() {
        return (IfcDuctSegmentTypeEnum) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcDuctSegmentType_PredefinedType(), true);
    }
    ...
    public void setPredefinedType(IfcDuctSegmentTypeEnum newPredefinedType) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcDuctSegmentType_PredefinedType(), newPredefinedType);
    }
