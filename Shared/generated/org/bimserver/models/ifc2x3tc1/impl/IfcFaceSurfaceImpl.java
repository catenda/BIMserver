...
public class IfcFaceSurfaceImpl extends IfcFaceImpl implements IfcFaceSurface {
    ...
    public IfcSurface getFaceSurface() {
        return (IfcSurface) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcFaceSurface_FaceSurface(), true);
    }
    ...
    public void setFaceSurface(IfcSurface newFaceSurface) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcFaceSurface_FaceSurface(), newFaceSurface);
    }
    ...
    public Tristate getSameSense() {
        return (Tristate) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcFaceSurface_SameSense(), true);
    }
    ...
    public void setSameSense(Tristate newSameSense) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcFaceSurface_SameSense(), newSameSense);
    }
