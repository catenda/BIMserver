...
public class IfcCompositeProfileDefImpl extends IfcProfileDefImpl implements IfcCompositeProfileDef {
    ...
    public EList<IfcProfileDef> getProfiles() {
        return (EList<IfcProfileDef>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeProfileDef_Profiles(), true);
    }
    ...
    public String getLabel() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeProfileDef_Label(), true);
    }
    ...
    public void setLabel(String newLabel) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeProfileDef_Label(), newLabel);
    }
    ...
    public void unsetLabel() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeProfileDef_Label());
    }
    ...
    public boolean isSetLabel() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeProfileDef_Label());
    }
