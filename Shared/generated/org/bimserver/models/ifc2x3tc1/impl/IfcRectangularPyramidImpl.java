...
public class IfcRectangularPyramidImpl extends IfcCsgPrimitive3DImpl implements IfcRectangularPyramid {
    ...
    public double getXLength() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_XLength(), true);
    }
    ...
    public void setXLength(double newXLength) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_XLength(), newXLength);
    }
    ...
    public String getXLengthAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_XLengthAsString(), true);
    }
    ...
    public void setXLengthAsString(String newXLengthAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_XLengthAsString(), newXLengthAsString);
    }
    ...
    public double getYLength() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_YLength(), true);
    }
    ...
    public void setYLength(double newYLength) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_YLength(), newYLength);
    }
    ...
    public String getYLengthAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_YLengthAsString(), true);
    }
    ...
    public void setYLengthAsString(String newYLengthAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_YLengthAsString(), newYLengthAsString);
    }
    ...
    public double getHeight() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_Height(), true);
    }
    ...
    public void setHeight(double newHeight) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_Height(), newHeight);
    }
    ...
    public String getHeightAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_HeightAsString(), true);
    }
    ...
    public void setHeightAsString(String newHeightAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangularPyramid_HeightAsString(), newHeightAsString);
    }
