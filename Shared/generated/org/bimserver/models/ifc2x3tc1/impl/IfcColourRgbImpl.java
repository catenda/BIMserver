...
public class IfcColourRgbImpl extends IfcColourSpecificationImpl implements IfcColourRgb {
    ...
    public double getRed() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_Red(), true);
    }
    ...
    public void setRed(double newRed) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_Red(), newRed);
    }
    ...
    public String getRedAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_RedAsString(), true);
    }
    ...
    public void setRedAsString(String newRedAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_RedAsString(), newRedAsString);
    }
    ...
    public double getGreen() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_Green(), true);
    }
    ...
    public void setGreen(double newGreen) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_Green(), newGreen);
    }
    ...
    public String getGreenAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_GreenAsString(), true);
    }
    ...
    public void setGreenAsString(String newGreenAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_GreenAsString(), newGreenAsString);
    }
    ...
    public double getBlue() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_Blue(), true);
    }
    ...
    public void setBlue(double newBlue) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_Blue(), newBlue);
    }
    ...
    public String getBlueAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_BlueAsString(), true);
    }
    ...
    public void setBlueAsString(String newBlueAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcColourRgb_BlueAsString(), newBlueAsString);
    }
