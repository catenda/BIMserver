...
public class IfcAnnotationFillAreaImpl extends IfcGeometricRepresentationItemImpl implements IfcAnnotationFillArea {
    ...
    public IfcCurve getOuterBoundary() {
        return (IfcCurve) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcAnnotationFillArea_OuterBoundary(), true);
    }
    ...
    public void setOuterBoundary(IfcCurve newOuterBoundary) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcAnnotationFillArea_OuterBoundary(), newOuterBoundary);
    }
    ...
    public EList<IfcCurve> getInnerBoundaries() {
        return (EList<IfcCurve>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcAnnotationFillArea_InnerBoundaries(), true);
    }
    ...
    public void unsetInnerBoundaries() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcAnnotationFillArea_InnerBoundaries());
    }
    ...
    public boolean isSetInnerBoundaries() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcAnnotationFillArea_InnerBoundaries());
    }
