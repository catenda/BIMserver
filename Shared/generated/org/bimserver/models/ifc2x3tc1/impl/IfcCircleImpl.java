...
public class IfcCircleImpl extends IfcConicImpl implements IfcCircle {
    ...
    public double getRadius() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCircle_Radius(), true);
    }
    ...
    public void setRadius(double newRadius) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCircle_Radius(), newRadius);
    }
    ...
    public String getRadiusAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCircle_RadiusAsString(), true);
    }
    ...
    public void setRadiusAsString(String newRadiusAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCircle_RadiusAsString(), newRadiusAsString);
    }
