...
public class IfcEdgeImpl extends IfcTopologicalRepresentationItemImpl implements IfcEdge {
    ...
    public IfcVertex getEdgeStart() {
        return (IfcVertex) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcEdge_EdgeStart(), true);
    }
    ...
    public void setEdgeStart(IfcVertex newEdgeStart) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcEdge_EdgeStart(), newEdgeStart);
    }
    ...
    public IfcVertex getEdgeEnd() {
        return (IfcVertex) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcEdge_EdgeEnd(), true);
    }
    ...
    public void setEdgeEnd(IfcVertex newEdgeEnd) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcEdge_EdgeEnd(), newEdgeEnd);
    }
