...
public class IfcTextLiteralWithExtentImpl extends IfcTextLiteralImpl implements IfcTextLiteralWithExtent {
    ...
    public IfcPlanarExtent getExtent() {
        return (IfcPlanarExtent) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTextLiteralWithExtent_Extent(), true);
    }
    ...
    public void setExtent(IfcPlanarExtent newExtent) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTextLiteralWithExtent_Extent(), newExtent);
    }
    ...
    public String getBoxAlignment() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTextLiteralWithExtent_BoxAlignment(), true);
    }
    ...
    public void setBoxAlignment(String newBoxAlignment) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTextLiteralWithExtent_BoxAlignment(), newBoxAlignment);
    }
