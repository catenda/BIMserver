...
public class IfcSectionedSpineImpl extends IfcGeometricRepresentationItemImpl implements IfcSectionedSpine {
    ...
    public IfcCompositeCurve getSpineCurve() {
        return (IfcCompositeCurve) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcSectionedSpine_SpineCurve(), true);
    }
    ...
    public void setSpineCurve(IfcCompositeCurve newSpineCurve) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcSectionedSpine_SpineCurve(), newSpineCurve);
    }
    ...
    public EList<IfcProfileDef> getCrossSections() {
        return (EList<IfcProfileDef>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcSectionedSpine_CrossSections(), true);
    }
    ...
    public EList<IfcAxis2Placement3D> getCrossSectionPositions() {
        return (EList<IfcAxis2Placement3D>) eGet(
                Ifc2x3tc1Package.eINSTANCE.getIfcSectionedSpine_CrossSectionPositions(), true);
    }
    ...
    @Override
    public long getDim() {
        return (Long) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcSectionedSpine_Dim(), true);
    }
    ...
    public void setDim(long newDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcSectionedSpine_Dim(), newDim);
    }
    ...
    public void unsetDim() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcSectionedSpine_Dim());
    }
    ...
    public boolean isSetDim() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcSectionedSpine_Dim());
    }
