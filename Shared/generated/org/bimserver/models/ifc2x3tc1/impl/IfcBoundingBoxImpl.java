...
public class IfcBoundingBoxImpl extends IfcGeometricRepresentationItemImpl implements IfcBoundingBox {
    ...
    public IfcCartesianPoint getCorner() {
        return (IfcCartesianPoint) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_Corner(), true);
    }
    ...
    public void setCorner(IfcCartesianPoint newCorner) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_Corner(), newCorner);
    }
    ...
    public double getXDim() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_XDim(), true);
    }
    ...
    public void setXDim(double newXDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_XDim(), newXDim);
    }
    ...
    public String getXDimAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_XDimAsString(), true);
    }
    ...
    public void setXDimAsString(String newXDimAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_XDimAsString(), newXDimAsString);
    }
    ...
    public double getYDim() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_YDim(), true);
    }
    ...
    public void setYDim(double newYDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_YDim(), newYDim);
    }
    ...
    public String getYDimAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_YDimAsString(), true);
    }
    ...
    public void setYDimAsString(String newYDimAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_YDimAsString(), newYDimAsString);
    }
    ...
    public double getZDim() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_ZDim(), true);
    }
    ...
    public void setZDim(double newZDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_ZDim(), newZDim);
    }
    ...
    public String getZDimAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_ZDimAsString(), true);
    }
    ...
    public void setZDimAsString(String newZDimAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_ZDimAsString(), newZDimAsString);
    }
    ...
    @Override
    public long getDim() {
        return (Long) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_Dim(), true);
    }
    ...
    public void setDim(long newDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_Dim(), newDim);
    }
    ...
    public void unsetDim() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_Dim());
    }
    ...
    public boolean isSetDim() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcBoundingBox_Dim());
    }
