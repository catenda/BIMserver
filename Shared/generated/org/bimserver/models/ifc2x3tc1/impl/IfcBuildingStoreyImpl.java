...
public class IfcBuildingStoreyImpl extends IfcSpatialStructureElementImpl implements IfcBuildingStorey {
    ...
    public double getElevation() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBuildingStorey_Elevation(), true);
    }
    ...
    public void setElevation(double newElevation) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBuildingStorey_Elevation(), newElevation);
    }
    ...
    public void unsetElevation() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcBuildingStorey_Elevation());
    }
    ...
    public boolean isSetElevation() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcBuildingStorey_Elevation());
    }
    ...
    public String getElevationAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBuildingStorey_ElevationAsString(), true);
    }
    ...
    public void setElevationAsString(String newElevationAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBuildingStorey_ElevationAsString(), newElevationAsString);
    }
    ...
    public void unsetElevationAsString() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcBuildingStorey_ElevationAsString());
    }
    ...
    public boolean isSetElevationAsString() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcBuildingStorey_ElevationAsString());
    }
