...
public class IfcConstraintRelationshipImpl extends IdEObjectImpl implements IfcConstraintRelationship {
    ...
    public String getName() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_Name(), true);
    }
    ...
    public void setName(String newName) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_Name(), newName);
    }
    ...
    public void unsetName() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_Name());
    }
    ...
    public boolean isSetName() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_Name());
    }
    ...
    public String getDescription() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_Description(), true);
    }
    ...
    public void setDescription(String newDescription) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_Description(), newDescription);
    }
    ...
    public void unsetDescription() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_Description());
    }
    ...
    public boolean isSetDescription() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_Description());
    }
    ...
    public IfcConstraint getRelatingConstraint() {
        return (IfcConstraint) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_RelatingConstraint(), true);
    }
    ...
    public void setRelatingConstraint(IfcConstraint newRelatingConstraint) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_RelatingConstraint(), newRelatingConstraint);
    }
    ...
    public EList<IfcConstraint> getRelatedConstraints() {
        return (EList<IfcConstraint>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcConstraintRelationship_RelatedConstraints(),
                true);
    }
