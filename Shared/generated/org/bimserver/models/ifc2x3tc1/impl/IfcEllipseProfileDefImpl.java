...
public class IfcEllipseProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcEllipseProfileDef {
    ...
    public double getSemiAxis1() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcEllipseProfileDef_SemiAxis1(), true);
    }
    ...
    public void setSemiAxis1(double newSemiAxis1) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcEllipseProfileDef_SemiAxis1(), newSemiAxis1);
    }
    ...
    public String getSemiAxis1AsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcEllipseProfileDef_SemiAxis1AsString(), true);
    }
    ...
    public void setSemiAxis1AsString(String newSemiAxis1AsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcEllipseProfileDef_SemiAxis1AsString(), newSemiAxis1AsString);
    }
    ...
    public double getSemiAxis2() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcEllipseProfileDef_SemiAxis2(), true);
    }
    ...
    public void setSemiAxis2(double newSemiAxis2) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcEllipseProfileDef_SemiAxis2(), newSemiAxis2);
    }
    ...
    public String getSemiAxis2AsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcEllipseProfileDef_SemiAxis2AsString(), true);
    }
    ...
    public void setSemiAxis2AsString(String newSemiAxis2AsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcEllipseProfileDef_SemiAxis2AsString(), newSemiAxis2AsString);
    }
