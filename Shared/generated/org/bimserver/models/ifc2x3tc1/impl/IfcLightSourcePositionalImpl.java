...
public class IfcLightSourcePositionalImpl extends IfcLightSourceImpl implements IfcLightSourcePositional {
    ...
    public IfcCartesianPoint getPosition() {
        return (IfcCartesianPoint) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_Position(), true);
    }
    ...
    public void setPosition(IfcCartesianPoint newPosition) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_Position(), newPosition);
    }
    ...
    public double getRadius() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_Radius(), true);
    }
    ...
    public void setRadius(double newRadius) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_Radius(), newRadius);
    }
    ...
    public String getRadiusAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_RadiusAsString(), true);
    }
    ...
    public void setRadiusAsString(String newRadiusAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_RadiusAsString(), newRadiusAsString);
    }
    ...
    public double getConstantAttenuation() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_ConstantAttenuation(), true);
    }
    ...
    public void setConstantAttenuation(double newConstantAttenuation) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_ConstantAttenuation(), newConstantAttenuation);
    }
    ...
    public String getConstantAttenuationAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_ConstantAttenuationAsString(),
                true);
    }
    ...
    public void setConstantAttenuationAsString(String newConstantAttenuationAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_ConstantAttenuationAsString(),
    ...
    public double getDistanceAttenuation() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_DistanceAttenuation(), true);
    }
    ...
    public void setDistanceAttenuation(double newDistanceAttenuation) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_DistanceAttenuation(), newDistanceAttenuation);
    }
    ...
    public String getDistanceAttenuationAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_DistanceAttenuationAsString(),
                true);
    }
    ...
    public void setDistanceAttenuationAsString(String newDistanceAttenuationAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_DistanceAttenuationAsString(),
    ...
    public double getQuadricAttenuation() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_QuadricAttenuation(), true);
    }
    ...
    public void setQuadricAttenuation(double newQuadricAttenuation) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_QuadricAttenuation(), newQuadricAttenuation);
    }
    ...
    public String getQuadricAttenuationAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_QuadricAttenuationAsString(), true);
    }
    ...
    public void setQuadricAttenuationAsString(String newQuadricAttenuationAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcLightSourcePositional_QuadricAttenuationAsString(),
