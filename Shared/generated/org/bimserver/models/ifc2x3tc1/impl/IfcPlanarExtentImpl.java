...
public class IfcPlanarExtentImpl extends IfcGeometricRepresentationItemImpl implements IfcPlanarExtent {
    ...
    public double getSizeInX() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcPlanarExtent_SizeInX(), true);
    }
    ...
    public void setSizeInX(double newSizeInX) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcPlanarExtent_SizeInX(), newSizeInX);
    }
    ...
    public String getSizeInXAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcPlanarExtent_SizeInXAsString(), true);
    }
    ...
    public void setSizeInXAsString(String newSizeInXAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcPlanarExtent_SizeInXAsString(), newSizeInXAsString);
    }
    ...
    public double getSizeInY() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcPlanarExtent_SizeInY(), true);
    }
    ...
    public void setSizeInY(double newSizeInY) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcPlanarExtent_SizeInY(), newSizeInY);
    }
    ...
    public String getSizeInYAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcPlanarExtent_SizeInYAsString(), true);
    }
    ...
    public void setSizeInYAsString(String newSizeInYAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcPlanarExtent_SizeInYAsString(), newSizeInYAsString);
    }
