...
public class IfcRightCircularCylinderImpl extends IfcCsgPrimitive3DImpl implements IfcRightCircularCylinder {
    ...
    public double getHeight() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRightCircularCylinder_Height(), true);
    }
    ...
    public void setHeight(double newHeight) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRightCircularCylinder_Height(), newHeight);
    }
    ...
    public String getHeightAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRightCircularCylinder_HeightAsString(), true);
    }
    ...
    public void setHeightAsString(String newHeightAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRightCircularCylinder_HeightAsString(), newHeightAsString);
    }
    ...
    public double getRadius() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRightCircularCylinder_Radius(), true);
    }
    ...
    public void setRadius(double newRadius) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRightCircularCylinder_Radius(), newRadius);
    }
    ...
    public String getRadiusAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRightCircularCylinder_RadiusAsString(), true);
    }
    ...
    public void setRadiusAsString(String newRadiusAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRightCircularCylinder_RadiusAsString(), newRadiusAsString);
    }
