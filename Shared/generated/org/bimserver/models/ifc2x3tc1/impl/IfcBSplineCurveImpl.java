...
public class IfcBSplineCurveImpl extends IfcBoundedCurveImpl implements IfcBSplineCurve {
    ...
    public long getDegree() {
        return (Long) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_Degree(), true);
    }
    ...
    public void setDegree(long newDegree) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_Degree(), newDegree);
    }
    ...
    public EList<IfcCartesianPoint> getControlPointsList() {
        return (EList<IfcCartesianPoint>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_ControlPointsList(), true);
    }
    ...
    public IfcBSplineCurveForm getCurveForm() {
        return (IfcBSplineCurveForm) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_CurveForm(), true);
    }
    ...
    public void setCurveForm(IfcBSplineCurveForm newCurveForm) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_CurveForm(), newCurveForm);
    }
    ...
    public boolean isClosedCurve() {
        return (Boolean) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_ClosedCurve(), true);
    }
    ...
    public void setClosedCurve(boolean newClosedCurve) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_ClosedCurve(), newClosedCurve);
    }
    ...
    public boolean isSelfIntersect() {
        return (Boolean) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_SelfIntersect(), true);
    }
    ...
    public void setSelfIntersect(boolean newSelfIntersect) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcBSplineCurve_SelfIntersect(), newSelfIntersect);
    }
