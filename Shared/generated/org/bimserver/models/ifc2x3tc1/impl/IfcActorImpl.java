...
public class IfcActorImpl extends IfcObjectImpl implements IfcActor {
    ...
    public IfcActorSelect getTheActor() {
        return (IfcActorSelect) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcActor_TheActor(), true);
    }
    ...
    public void setTheActor(IfcActorSelect newTheActor) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcActor_TheActor(), newTheActor);
    }
    ...
    public EList<IfcRelAssignsToActor> getIsActingUpon() {
        return (EList<IfcRelAssignsToActor>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcActor_IsActingUpon(), true);
    }
    ...
    public void unsetIsActingUpon() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcActor_IsActingUpon());
    }
    ...
    public boolean isSetIsActingUpon() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcActor_IsActingUpon());
    }
