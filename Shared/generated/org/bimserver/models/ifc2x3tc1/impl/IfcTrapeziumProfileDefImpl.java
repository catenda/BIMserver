...
public class IfcTrapeziumProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcTrapeziumProfileDef {
    ...
    public double getBottomXDim() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_BottomXDim(), true);
    }
    ...
    public void setBottomXDim(double newBottomXDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_BottomXDim(), newBottomXDim);
    }
    ...
    public String getBottomXDimAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_BottomXDimAsString(), true);
    }
    ...
    public void setBottomXDimAsString(String newBottomXDimAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_BottomXDimAsString(), newBottomXDimAsString);
    }
    ...
    public double getTopXDim() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_TopXDim(), true);
    }
    ...
    public void setTopXDim(double newTopXDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_TopXDim(), newTopXDim);
    }
    ...
    public String getTopXDimAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_TopXDimAsString(), true);
    }
    ...
    public void setTopXDimAsString(String newTopXDimAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_TopXDimAsString(), newTopXDimAsString);
    }
    ...
    public double getYDim() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_YDim(), true);
    }
    ...
    public void setYDim(double newYDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_YDim(), newYDim);
    }
    ...
    public String getYDimAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_YDimAsString(), true);
    }
    ...
    public void setYDimAsString(String newYDimAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_YDimAsString(), newYDimAsString);
    }
    ...
    public double getTopXOffset() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_TopXOffset(), true);
    }
    ...
    public void setTopXOffset(double newTopXOffset) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_TopXOffset(), newTopXOffset);
    }
    ...
    public String getTopXOffsetAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_TopXOffsetAsString(), true);
    }
    ...
    public void setTopXOffsetAsString(String newTopXOffsetAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrapeziumProfileDef_TopXOffsetAsString(), newTopXOffsetAsString);
    }
