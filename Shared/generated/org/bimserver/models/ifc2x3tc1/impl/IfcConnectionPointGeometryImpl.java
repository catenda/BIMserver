...
public class IfcConnectionPointGeometryImpl extends IfcConnectionGeometryImpl implements IfcConnectionPointGeometry {
    ...
    public IfcPointOrVertexPoint getPointOnRelatingElement() {
        return (IfcPointOrVertexPoint) eGet(
                Ifc2x3tc1Package.eINSTANCE.getIfcConnectionPointGeometry_PointOnRelatingElement(), true);
    }
    ...
    public void setPointOnRelatingElement(IfcPointOrVertexPoint newPointOnRelatingElement) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcConnectionPointGeometry_PointOnRelatingElement(),
    ...
    public IfcPointOrVertexPoint getPointOnRelatedElement() {
        return (IfcPointOrVertexPoint) eGet(
                Ifc2x3tc1Package.eINSTANCE.getIfcConnectionPointGeometry_PointOnRelatedElement(), true);
    }
    ...
    public void setPointOnRelatedElement(IfcPointOrVertexPoint newPointOnRelatedElement) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcConnectionPointGeometry_PointOnRelatedElement(),
    ...
    public void unsetPointOnRelatedElement() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcConnectionPointGeometry_PointOnRelatedElement());
    }
    ...
    public boolean isSetPointOnRelatedElement() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcConnectionPointGeometry_PointOnRelatedElement());
    }
