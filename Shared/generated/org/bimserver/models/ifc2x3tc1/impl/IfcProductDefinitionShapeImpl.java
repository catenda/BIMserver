...
public class IfcProductDefinitionShapeImpl extends IfcProductRepresentationImpl implements IfcProductDefinitionShape {
    ...
    public EList<IfcProduct> getShapeOfProduct() {
        return (EList<IfcProduct>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcProductDefinitionShape_ShapeOfProduct(), true);
    }
    ...
    public void unsetShapeOfProduct() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcProductDefinitionShape_ShapeOfProduct());
    }
    ...
    public boolean isSetShapeOfProduct() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcProductDefinitionShape_ShapeOfProduct());
    }
    ...
    public EList<IfcShapeAspect> getHasShapeAspects() {
        return (EList<IfcShapeAspect>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcProductDefinitionShape_HasShapeAspects(),
                true);
    }
    ...
    public void unsetHasShapeAspects() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcProductDefinitionShape_HasShapeAspects());
    }
    ...
    public boolean isSetHasShapeAspects() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcProductDefinitionShape_HasShapeAspects());
    }
