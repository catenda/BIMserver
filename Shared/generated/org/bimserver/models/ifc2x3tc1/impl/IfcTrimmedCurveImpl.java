...
public class IfcTrimmedCurveImpl extends IfcBoundedCurveImpl implements IfcTrimmedCurve {
    ...
    public IfcCurve getBasisCurve() {
        return (IfcCurve) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrimmedCurve_BasisCurve(), true);
    }
    ...
    public void setBasisCurve(IfcCurve newBasisCurve) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrimmedCurve_BasisCurve(), newBasisCurve);
    }
    ...
    public EList<IfcTrimmingSelect> getTrim1() {
        return (EList<IfcTrimmingSelect>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrimmedCurve_Trim1(), true);
    }
    ...
    public EList<IfcTrimmingSelect> getTrim2() {
        return (EList<IfcTrimmingSelect>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrimmedCurve_Trim2(), true);
    }
    ...
    public Tristate getSenseAgreement() {
        return (Tristate) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrimmedCurve_SenseAgreement(), true);
    }
    ...
    public void setSenseAgreement(Tristate newSenseAgreement) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrimmedCurve_SenseAgreement(), newSenseAgreement);
    }
    ...
    public IfcTrimmingPreference getMasterRepresentation() {
        return (IfcTrimmingPreference) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcTrimmedCurve_MasterRepresentation(), true);
    }
    ...
    public void setMasterRepresentation(IfcTrimmingPreference newMasterRepresentation) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcTrimmedCurve_MasterRepresentation(), newMasterRepresentation);
    }
