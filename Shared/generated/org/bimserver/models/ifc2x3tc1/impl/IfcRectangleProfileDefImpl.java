...
public class IfcRectangleProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcRectangleProfileDef {
    ...
    public double getXDim() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangleProfileDef_XDim(), true);
    }
    ...
    public void setXDim(double newXDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangleProfileDef_XDim(), newXDim);
    }
    ...
    public String getXDimAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangleProfileDef_XDimAsString(), true);
    }
    ...
    public void setXDimAsString(String newXDimAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangleProfileDef_XDimAsString(), newXDimAsString);
    }
    ...
    public double getYDim() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangleProfileDef_YDim(), true);
    }
    ...
    public void setYDim(double newYDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangleProfileDef_YDim(), newYDim);
    }
    ...
    public String getYDimAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangleProfileDef_YDimAsString(), true);
    }
    ...
    public void setYDimAsString(String newYDimAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRectangleProfileDef_YDimAsString(), newYDimAsString);
    }
