...
public class IfcRelAssignsToActorImpl extends IfcRelAssignsImpl implements IfcRelAssignsToActor {
    ...
    public IfcActor getRelatingActor() {
        return (IfcActor) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRelAssignsToActor_RelatingActor(), true);
    }
    ...
    public void setRelatingActor(IfcActor newRelatingActor) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRelAssignsToActor_RelatingActor(), newRelatingActor);
    }
    ...
    public IfcActorRole getActingRole() {
        return (IfcActorRole) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcRelAssignsToActor_ActingRole(), true);
    }
    ...
    public void setActingRole(IfcActorRole newActingRole) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcRelAssignsToActor_ActingRole(), newActingRole);
    }
    ...
    public void unsetActingRole() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcRelAssignsToActor_ActingRole());
    }
    ...
    public boolean isSetActingRole() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcRelAssignsToActor_ActingRole());
    }
