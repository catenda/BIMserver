...
public class IfcSurfaceStyleRefractionImpl extends IdEObjectImpl implements IfcSurfaceStyleRefraction {
    ...
    public double getRefractionIndex() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_RefractionIndex(), true);
    }
    ...
    public void setRefractionIndex(double newRefractionIndex) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_RefractionIndex(), newRefractionIndex);
    }
    ...
    public void unsetRefractionIndex() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_RefractionIndex());
    }
    ...
    public boolean isSetRefractionIndex() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_RefractionIndex());
    }
    ...
    public String getRefractionIndexAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_RefractionIndexAsString(), true);
    }
    ...
    public void setRefractionIndexAsString(String newRefractionIndexAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_RefractionIndexAsString(),
    ...
    public void unsetRefractionIndexAsString() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_RefractionIndexAsString());
    }
    ...
    public boolean isSetRefractionIndexAsString() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_RefractionIndexAsString());
    }
    ...
    public double getDispersionFactor() {
        return (Double) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_DispersionFactor(), true);
    }
    ...
    public void setDispersionFactor(double newDispersionFactor) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_DispersionFactor(), newDispersionFactor);
    }
    ...
    public void unsetDispersionFactor() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_DispersionFactor());
    }
    ...
    public boolean isSetDispersionFactor() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_DispersionFactor());
    }
    ...
    public String getDispersionFactorAsString() {
        return (String) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_DispersionFactorAsString(), true);
    }
    ...
    public void setDispersionFactorAsString(String newDispersionFactorAsString) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_DispersionFactorAsString(),
    ...
    public void unsetDispersionFactorAsString() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_DispersionFactorAsString());
    }
    ...
    public boolean isSetDispersionFactorAsString() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcSurfaceStyleRefraction_DispersionFactorAsString());
    }
