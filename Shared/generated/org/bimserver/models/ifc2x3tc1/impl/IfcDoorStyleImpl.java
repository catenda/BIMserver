...
public class IfcDoorStyleImpl extends IfcTypeProductImpl implements IfcDoorStyle {
    ...
    public IfcDoorStyleOperationEnum getOperationType() {
        return (IfcDoorStyleOperationEnum) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcDoorStyle_OperationType(), true);
    }
    ...
    public void setOperationType(IfcDoorStyleOperationEnum newOperationType) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcDoorStyle_OperationType(), newOperationType);
    }
    ...
    public IfcDoorStyleConstructionEnum getConstructionType() {
        return (IfcDoorStyleConstructionEnum) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcDoorStyle_ConstructionType(), true);
    }
    ...
    public void setConstructionType(IfcDoorStyleConstructionEnum newConstructionType) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcDoorStyle_ConstructionType(), newConstructionType);
    }
    ...
    public Tristate getParameterTakesPrecedence() {
        return (Tristate) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcDoorStyle_ParameterTakesPrecedence(), true);
    }
    ...
    public void setParameterTakesPrecedence(Tristate newParameterTakesPrecedence) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcDoorStyle_ParameterTakesPrecedence(), newParameterTakesPrecedence);
    }
    ...
    public Tristate getSizeable() {
        return (Tristate) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcDoorStyle_Sizeable(), true);
    }
    ...
    public void setSizeable(Tristate newSizeable) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcDoorStyle_Sizeable(), newSizeable);
    }
