...
public class IfcCompositeCurveSegmentImpl extends IfcGeometricRepresentationItemImpl
    ...
    public IfcTransitionCode getTransition() {
        return (IfcTransitionCode) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_Transition(), true);
    }
    ...
    public void setTransition(IfcTransitionCode newTransition) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_Transition(), newTransition);
    }
    ...
    public Tristate getSameSense() {
        return (Tristate) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_SameSense(), true);
    }
    ...
    public void setSameSense(Tristate newSameSense) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_SameSense(), newSameSense);
    }
    ...
    public IfcCurve getParentCurve() {
        return (IfcCurve) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_ParentCurve(), true);
    }
    ...
    public void setParentCurve(IfcCurve newParentCurve) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_ParentCurve(), newParentCurve);
    }
    ...
    public EList<IfcCompositeCurve> getUsingCurves() {
        return (EList<IfcCompositeCurve>) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_UsingCurves(),
                true);
    }
    ...
    public void unsetUsingCurves() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_UsingCurves());
    }
    ...
    public boolean isSetUsingCurves() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_UsingCurves());
    }
    ...
    @Override
    public long getDim() {
        return (Long) eGet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_Dim(), true);
    }
    ...
    public void setDim(long newDim) {
        eSet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_Dim(), newDim);
    }
    ...
    public void unsetDim() {
        eUnset(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_Dim());
    }
    ...
    public boolean isSetDim() {
        return eIsSet(Ifc2x3tc1Package.eINSTANCE.getIfcCompositeCurveSegment_Dim());
    }
